...
import com.huda.submission_4_made.ui.favoritemovie.FavoriteMovieFragment
...
class DetailFavoriteMovie : AppCompatActivity() {
    ...
    private class DeleteTask(var context: DetailFavoriteMovie, var id: Long) : AsyncTask<Void, Void, Boolean>() {
        ...
        override fun onPostExecute(bool: Boolean?) {
            if (bool!!) {
                val intent = Intent(context, FavoriteMovieFragment::class.java)
